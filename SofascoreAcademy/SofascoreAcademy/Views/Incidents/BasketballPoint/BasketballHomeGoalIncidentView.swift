//
//  BasketballHomeGoalIncidentView.swift
//  SofascoreAcademy
//
...
class BasketballHomeGoalIncidentView: BaseView {
    ...
    override func setupConstraints() {
        ...
        currentScoreLabelView.snp.makeConstraints {
            $0.leading.equalTo(verticalDividerView.snp.trailing).offset(4)
            $0.top.bottom.equalToSuperview().inset(12)
            $0.trailing.equalTo(incidentMinuteLabelView.snp.leading).offset(-28)
        }
...
extension BasketballHomeGoalIncidentView {
    @discardableResult
