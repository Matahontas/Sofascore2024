...
class HomeGoalIncidentView: BaseView {
    ...
    override func setupConstraints() {
        ...
        stackView.snp.makeConstraints {
            $0.leading.equalTo(preDividerContainer.snp.trailing).offset(8)
            $0.top.bottom.equalToSuperview().inset(14)
        }
    }
}

extension HomeGoalIncidentView {
    @discardableResult
