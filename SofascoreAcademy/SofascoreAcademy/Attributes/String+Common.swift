...
extension String {
    ...
    static let england = NSLocalizedString("England", comment: "Country")
    static let france = NSLocalizedString("France", comment: "Country")
    static let italy = NSLocalizedString("Italy", comment: "Country")
    ...
    static let serie_a = NSLocalizedString("Serie A", comment: "League")
    static let premier_league = NSLocalizedString("Premier League", comment: "League")
